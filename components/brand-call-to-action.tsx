...
export const CallToAction = () => {
  return (
    <section className='base-border mx-auto flex w-full max-w-5xl flex-col gap-8 rounded-lg p-8 md:flex-row md:items-center'>
      <section className='flex w-full flex-col gap-5 sm:gap-12'>
        <div className='flex flex-col gap-4 '>
          <h2 className='max-w-md font-sans font-bold leading-relaxed sm:text-4xl'>
      ...
      <Image
        ...
        className='max-h-[180px] w-full rounded-lg object-cover md:max-h-[240px] md:max-w-[300px]'
      />
    </section>
  );
};
