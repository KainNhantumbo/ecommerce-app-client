  ...
  return (
    <main className='mt-[70px] flex w-full flex-col gap-12 px-4 font-sans'>
      <section className='mx-auto w-full max-w-5xl'>
        ...
        <h2 className='py-4 leading-relaxed'>Welcome to {constants.name}!</h2>
        <p className='py-3 leading-relaxed'>
          These terms and conditions outline the rules and regulations for the use of{' '}
          {constants.name}'s Website, located at {constants.url}.
        </p>

        <p className='py-3 leading-relaxed'>
          By accessing this website we assume you accept these terms and conditions. Do
          not continue to use {constants.name} if you do not agree to take all of the
        ...
        <p className='py-3 leading-relaxed'>
          ...
          with and subject to, prevailing law of us. Any use of the above terminology or
        ...
        <h3 className='py-3 leading-relaxed'>Cookies</h3>
        <p className='py-3 leading-relaxed'>
          We employ the use of cookies. By accessing {constants.name}, you agreed to use
          cookies in agreement with the {constants.name}'s Privacy Policy.
        </p>
        ...
        <h3 className='py-3 leading-relaxed'>License</h3>
        <p className='py-3 leading-relaxed'>
          Unless otherwise stated, {constants.name} and/or its licensors own the
          intellectual property rights for all material on {constants.name}. All
          intellectual property rights are reserved. You may access this from
          {constants.name} for your own personal use subjected to restrictions set in
          these terms and conditions.
        </p>

        <p className='py-3 leading-relaxed'>You must not:</p>
        <ul>
          <li>Republish material from {constants.name}</li>
          <li>Sell, rent or sub-license material from {constants.name}</li>
          <li>Reproduce, duplicate or copy material from {constants.name}</li>
          <li>Redistribute content from {constants.name}</li>
        </ul>
        <p className='py-3 leading-relaxed'>
        ...
        <p className='py-3 leading-relaxed'>
          ...
          {constants.name} does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and opinions
          of {constants.name},its agents and/or affiliates. Comments reflect the views
          and opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, {constants.name} shall not be liable for the
        ...
        <p className='py-3 leading-relaxed'>
          {constants.name} reserves the right to monitor all Comments and to remove any
          Comments which can be considered inappropriate, offensive or causes breach of
          these Terms and Conditions.
        </p>
        <p className='py-3 leading-relaxed'>You warrant and represent that:</p>
        <ul>
          <li>
        ...
        <p className='py-3 leading-relaxed'>
          ...
          absence of {constants.name}; and (d) the link is in the context of general
        ...
        <p className='py-3 leading-relaxed'>
          ...
          to {constants.name}. Please include your name, your organization name, contact
        ...
        <p className='py-3 leading-relaxed'>
          No use of {constants.name}'s logo or other artwork will be allowed for linking
        ...
        <h3 className='py-3 leading-relaxed'>Acceptance of this policy</h3>
        <p className='py-3 leading-relaxed'>
        ...
        <h3 className='py-3 leading-relaxed'>Contacting us</h3>
        <p className='py-3 leading-relaxed'>
