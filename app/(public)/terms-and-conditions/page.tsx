    ...
    <main className='w-full px-4 mt-[70px] font-sans flex flex-col gap-12'>
      <section className='w-full max-w-[890px] mx-auto'>
        ...
        <p className='py-3 leading-relaxed'>
          ...
          use of {constants.name}'s Website, located at {constants.url}.
        </p>

        <p className='py-3 leading-relaxed'>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use {constants.name} if you do not
        ...
        <p className='py-3 leading-relaxed'>
          We employ the use of cookies. By accessing {constants.name}, you
          agreed to use cookies in agreement with the {constants.name}'s Privacy
          Policy.
        </p>
        ...
        <p className='py-3 leading-relaxed'>
          ...
          {constants.name} for your own personal use subjected to restrictions
        ...
        <p className='py-3 leading-relaxed'>
          ...
          {constants.name} does not filter, edit, publish or review Comments
          prior to their presence on the website. Comments do not reflect the
          views and opinions of {constants.name},its agents and/or affiliates.
          ...
          {constants.name} shall not be liable for the Comments or for any
        ...
        <p className='py-3 leading-relaxed'>
          {constants.name} reserves the right to monitor all Comments and to
        ...
        <p className='py-3 leading-relaxed'>
          You hereby grant {constants.name} a non-exclusive license to use,
        ...
        <p className='py-3 leading-relaxed'>
          ...
          the hyperlink compensates the absence of {constants.name}; and (d) the
        ...
        <p className='py-3 leading-relaxed'>
          ...
          sending an e-mail to {constants.name}. Please include your name, your
        ...
        <p className='py-3 leading-relaxed'>
          No use of {constants.name}'s logo or other artwork will be allowed for
