    ...
    <main className='mt-[70px] flex w-full flex-col gap-12 px-4 font-sans'>
      <section className='mx-auto w-full max-w-5xl'>
        ...
        <p className='py-3 leading-relaxed'>
          ...
          continue to use {constants.name} if you do not agree to take all of the terms and
        ...
        <p className='py-3 leading-relaxed'>
          ...
          prevailing law of us. Any use of the above terminology or other words in the
        ...
        <p className='py-3 leading-relaxed'>
          ...
          {constants.name} for your own personal use subjected to restrictions set in these
        ...
        <p className='py-3 leading-relaxed'>
          ...
          {constants.name} does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and opinions of{' '}
          {constants.name},its agents and/or affiliates. Comments reflect the views and
          opinions of the person who post their views and opinions. To the extent permitted
          by applicable laws, {constants.name} shall not be liable for the Comments or for
        ...
        <p className='py-3 leading-relaxed'>
          You hereby grant {constants.name} a non-exclusive license to use, reproduce, edit
        ...
        <p className='py-3 leading-relaxed'>
          ...
          {constants.name}; and (d) the link is in the context of general resource
          information.
        </p>
        <p className='py-3 leading-relaxed'>
        ...
        <p className='py-3 leading-relaxed'>
          ...
          {constants.name}. Please include your name, your organization name, contact
