    ...
    <main className='mx-auto mt-24 flex w-full max-w-5xl flex-col gap-8 px-4 font-sans-body text-lg'>
      <section className='flex w-full flex-wrap-reverse items-center  justify-center gap-8 sm:flex-nowrap sm:gap-3'>
        <div className='flex max-w-[500px] flex-col gap-3'>
          ...
          <p>
            Welcome to our store, your ultimate destination for fashion-forward clothing
            and accessories! At {constants.name}, we believe that style is a reflection
            of individuality, and we're here to help you express yourself confidently
            through our curated collection of trendy apparel.
          </p>
        </div>
        <Image
          src={aboutImage}
