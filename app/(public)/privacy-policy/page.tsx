    ...
    <main className='mt-[70px] flex w-full flex-col gap-12 px-4 font-sans'>
      <section className='mx-auto w-full max-w-5xl'>
        ...
        <p className='py-3 leading-relaxed'>
          At {constants.name}, accessible from {constants.url}, one of our main
          priorities is the privacy of our visitors. This Privacy Policy document
          contains types of information that is collected and recorded by{' '}
          {constants.name} and how we use it.
        </p>
        <p className='py-3 leading-relaxed'>
        ...
        <p className='py-3 leading-relaxed'>
          {constants.name} follows a standard procedure of using log files. These files
        ...
        <p className='py-3 leading-relaxed'>
          ...
          and links that appear on {constants.name}, which are sent directly to users'
        ...
        <p className='py-3 leading-relaxed'>
          Note that {constants.name} has no access to or control over these cookies that
        ...
        <p className='py-3 leading-relaxed'>
          ...
          and/or collect in {constants.name}. This policy is not applicable to any
