    ...
    <main className='w-full px-4 mt-[70px] font-sans flex flex-col gap-12'>
      <section className='w-full max-w-[890px] mx-auto'>
        ...
        <p className='py-3 leading-relaxed'>
          At {constants.name}, accessible from {constants.url}, one of our
          main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded
          by {constants.name} and how we use it.
        </p>
        <p className='py-3 leading-relaxed'>
        ...
        <p className='py-3 leading-relaxed'>
          {constants.name} follows a standard procedure of using log files. These
        ...
        <p className='py-3 leading-relaxed'>
          Like any other website, {constants.name} uses "cookies". These cookies are
        ...
        &gt;&gt;&gt;&gt;&gt;&gt;&gt; parent of e1b9ab7 ([brands] Updated credits
        link)
        ...
        <p className='py-3 leading-relaxed'>
          ...
          advertising partners of {constants.name}.
        </p>
        <p className='py-3 leading-relaxed'>
          Third-party ad servers or ad networks uses technologies like cookies,
          JavaScript, or Web Beacons that are used in their respective
          advertisements and links that appear on {constants.name}, which are sent
        ...
        <p className='py-3 leading-relaxed'>
          Note that {constants.name} has no access to or control over these cookies
          that are used by third-party advertisers.
        </p>
        <h2 className='py-2 leading-relaxed'>Third Party Privacy Policies</h2>
        <p className='py-3 leading-relaxed'>
          {constants.name}'s Privacy Policy does not apply to other advertisers or
        ...
        <p className='py-3 leading-relaxed'>
          {constants.name} does not knowingly collect any Personal Identifiable
        ...
        <p className='py-3 leading-relaxed'>
          ...
          shared and/or collect in {constants.name}. This policy is not applicable to
